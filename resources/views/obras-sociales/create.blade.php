...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
            <div class="mb-4">
                <h1 class="text-xl font-bold">Crear Nueva Obra Social</h1>
            </div>
            ...
            <form action="{{ route('obras-sociales.store') }}" method="POST">
                ...
                <div class="flex items-center justify-between">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Guardar Obra Social</button>
                </div>
            </form>
        </div>
    </div>
